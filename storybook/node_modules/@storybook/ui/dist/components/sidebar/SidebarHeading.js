...
var SidebarHeading = (0, _recompose.withState)('tooltipShown', 'onVisibilityChange', false)(function (_ref3) {
  var menuHighlighted = _ref3.menuHighlighted,
      menu = _ref3.menu,
      tooltipShown = _ref3.tooltipShown,
      onVisibilityChange = _ref3.onVisibilityChange,
      props = _objectWithoutProperties(_ref3, ["menuHighlighted", "menu", "tooltipShown", "onVisibilityChange"]);
      ...
      links: menu.map(function (i) {
        return Object.assign({}, i, {
          onClick: function onClick() {
            return onVisibilityChange(false) || i.onClick.apply(i, arguments);
          }
        });
      })
    }),
