...
var baseStyle = function baseStyle(_ref) {
  ...
  return {
    ...
    backgroundColor: theme.base === 'light' ? (0, _polished.rgba)("".concat((0, _polished.darken)(1, theme.background.app)), 0.95) : (0, _polished.rgba)("".concat((0, _polished.lighten)(1, theme.background.app)), 0.95),
    textDecoration: 'none'
  };
};
