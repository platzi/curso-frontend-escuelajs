...
var renderIframe = function renderIframe(storyId, id, baseUrl, scale, queryParams) {
  return _react["default"].createElement(_iframe.IFrame, {
    key: "iframe",
    id: "storybook-preview-iframe",
    title: id || 'preview',
    src: "".concat(baseUrl, "?id=").concat(storyId).concat(stringifyQueryParams(queryParams)),
...
var ActualPreview = function ActualPreview(_ref3) {
  ...
  var data = [storyId, id, baseUrl, scale, queryParams];
...
var defaultWrappers = [{
  ...
  render: function render(p) {
    return _react["default"].createElement(_background.BackgroundConsumer, null, function (_ref4) {
      var value = _ref4.value,
          grid = _ref4.grid;
      return _react["default"].createElement(_background.Background, {
        id: "storybook-preview-background",
        value: value
      }, grid ? _ref5 : null, p.children);
    });
  }
}];
...
var getTools = (0, _memoizerific["default"])(10)(function (getElements, queryParams, panels, api, options, storyId, viewMode, location, path, baseUrl) {
  var tools = getElementList(getElements, _addons.types.TOOL, [panels.filter(function (p) {
    ...
    render: function render() {
      return _react["default"].createElement(_react.Fragment, null, _react["default"].createElement(_zoom.ZoomConsumer, null, function (_ref7) {
        var _set = _ref7.set,
            value = _ref7.value;
    ...
    render: function render() {
      return _react["default"].createElement(_background.BackgroundConsumer, null, function (_ref9) {
        var setGrid = _ref9.setGrid,
            grid = _ref9.grid;
...
function (_Component) {
  ...
  _createClass(Preview, [{
    ...
    value: function shouldComponentUpdate(_ref13) {
      var storyId = _ref13.storyId,
          viewMode = _ref13.viewMode,
          options = _ref13.options,
          queryParams = _ref13.queryParams;
    ...
    value: function render() {
      ...
      var panels = getElementList(getElements, _addons.types.TAB, [{
        ...
        render: function render(p) {
          return _react["default"].createElement(_zoom.ZoomConsumer, null, function (_ref14) {
      ...
      return _react["default"].createElement(_background.BackgroundProvider, null, _react["default"].createElement(_zoom.ZoomProvider, null, _react["default"].createElement(_react.Fragment, null, id === 'main' && _react["default"].createElement(_reactHelmetAsync.Helmet, {
        key: "description"
