...
(0, _react2.storiesOf)('UI|Layout/Desktop', module).addDecorator(_addonKnobs.withKnobs).addDecorator(function (storyFn) {
...
}).add('bottom Panel', function (_ref5) {
...
}).add('no Panel, no Nav', function (_ref7) {
...
(0, _react2.storiesOf)('UI|Layout/Mobile', module).addDecorator(_addonKnobs.withKnobs).addDecorator(function (storyFn) {
  var mocked = (0, _addonKnobs["boolean"])('mock', true);
  var props = Object.assign({}, mocked ? mockProps : realProps);
  return storyFn({
    props: props
  });
}).add('initial 0', function (_ref11) {
