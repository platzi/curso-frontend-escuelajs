...
var Arrow = _theming.styled.div({
  ...
  return {
    ...
    borderTopColor: match('top', placement, theme.color[color] || color || theme.base === 'light' ? (0, _polished.rgba)("".concat((0, _polished.lighten)(1, theme.background.app)), 0.95) : (0, _polished.rgba)("".concat((0, _polished.darken)(1, theme.background.app)), 0.95), 'transparent'),
    borderBottomColor: match('bottom', placement, theme.color[color] || color || theme.base === 'light' ? (0, _polished.rgba)("".concat((0, _polished.lighten)(1, theme.background.app)), 0.95) : (0, _polished.rgba)("".concat((0, _polished.darken)(1, theme.background.app)), 0.95), 'transparent'),
    borderLeftColor: match('left', placement, theme.color[color] || color || theme.base === 'light' ? (0, _polished.rgba)("".concat((0, _polished.lighten)(1, theme.background.app)), 0.95) : (0, _polished.rgba)("".concat((0, _polished.darken)(1, theme.background.app)), 0.95), 'transparent'),
    borderRightColor: match('right', placement, theme.color[color] || color || theme.base === 'light' ? (0, _polished.rgba)("".concat((0, _polished.lighten)(1, theme.background.app)), 0.95) : (0, _polished.rgba)("".concat((0, _polished.darken)(1, theme.background.app)), 0.95), 'transparent')
  };
});
...
var Wrapper = _theming.styled.div(function (_ref2) {
  ...
  return hasChrome ? {
    ...
    background: theme.color[color] || color || theme.base === 'light' ? (0, _polished.rgba)("".concat((0, _polished.lighten)(1, theme.background.app)), 0.95) : (0, _polished.rgba)("".concat((0, _polished.darken)(1, theme.background.app)), 0.95),
